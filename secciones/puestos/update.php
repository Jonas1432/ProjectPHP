...
if($_POST){
  ...
  $sentencia=$conexion->prepare("UPDATE tbl_puesto SET puesto=:puesto, area=:area WHERE id=:id");
    ...
    <form class="row g-3 needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
      ...
      <div class="row mb-4">
        ...
        <div class="col-6">
          ...
          <div class="form-outline">
            <input type="text" id="puesto" value="<?php echo $puesto?>" name="puesto" class="form-control" />
        ...
        <div class="col-6">
          ...
          <div class="form-outline">
            <input type="text" id="area" value="<?php echo $area?>" name="area" class="form-control" required />
